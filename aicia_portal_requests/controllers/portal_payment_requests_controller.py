...
class PortalPaymentController(Controller):
    ...
    def portal_my_payments(self, search=None, search_in='all', groupby='none', filterby='all', **kwargs):
        ...
        return request.render('aicia_portal_requests.portal_my_payments', values)
    ...
    def portal_my_payment_detail(self, payment_id, **kwargs):
        ...
        return request.render('aicia_portal_requests.portal_my_payment_detail', {
            'payment': payment,
    ...
    def portal_my_payment_invoices(self, payment_id, **kwargs):
        ...
        if not payment:
            return request.not_found()
        return request.render('aicia_portal_requests.portal_payment_invoices', {
            'payment': payment,
            'invoices': visible_invoices,
    ...
    def portal_my_payment_invoice_detail(self, payment_id, invoice_id, **kwargs):
        ...
        if not invoice:
            return request.not_found()
        return request.render('aicia_portal_requests.portal_payment_invoice_detail', {
            'payment': payment,
            'invoice': invoice,
    ...
    def portal_my_payment_invoice_payments(self, payment_id, invoice_id, **kwargs):
        ...
        if not payment or not invoice:
            return request.not_found()
        return request.render('aicia_portal_requests.portal_invoice_payments', {
            'payment': payment,
            'invoice': invoice,
