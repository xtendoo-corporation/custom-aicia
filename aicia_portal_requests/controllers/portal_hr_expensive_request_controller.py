...
class PortalHrExpensiveRequestController(Controller):
    ...
    def hr_expensive_request_form(self, **kwargs):
        ...
        if allowed_work_groups and user.has_group('aicia_portal_requests.group_equip_boss'):
        ...
        return request.render('aicia_portal_requests.portal_hr_expensive_request_template', {
    ...
    def hr_expensive_request_submit(self, **post):
        ...
        if int(user_id) == int(work_group_id.equip_boss.id):
            ...
            group = request.env.ref('aicia_portal_requests.group_personnel_purchase_responsible').sudo()
