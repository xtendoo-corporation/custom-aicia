...
class PortalRequestsCustomerPortal(CustomerPortal):
    ...
    def _get_accessible_analytic_project_domain(self, user):
        ...
        if user.has_group('aicia_portal_requests.group_equip_boss'):
    ...
    def _prepare_home_portal_values(self, counters):
        ...
        values['is_equip_boss'] = request.env.user.has_group('aicia_portal_requests.group_equip_boss')
    ...
    def portal_my_expenses(self, page=1, sortby=None, filterby=None, search=None, search_in='all', groupby='none', **kw):
        ...
        return request.render("aicia_portal_requests.portal_my_expenses", values)
    ...
    def portal_my_expense_detail(self, expense_id, success=None, **kw):
        ...
        return request.render("aicia_portal_requests.portal_my_expense_detail", values)
    ...
    def portal_expense_thank_you(self, **kw):
        ...
        return request.render("aicia_portal_requests.hr_expensive_request_thank_you")
    ...
    def portal_my_invoices(self, page=1, sortby=None, filterby=None, search=None, search_in='all', groupby='none', **kw):
        ...
        return request.render("aicia_portal_requests.portal_my_invoices", values)
    ...
    def portal_my_invoice_detail(self, invoice_request_id, success=None, **kw):
        ...
        return request.render("aicia_portal_requests.portal_my_invoice_detail", values)
    ...
    def portal_invoice_view_created_invoice(self, invoice_request_id, success=None, **kw):
        ...
        return request.render("aicia_portal_requests.portal_invoice_view", values)
    ...
    def portal_invoice_thank_you(self, **kw):
        ...
        return request.render("aicia_portal_requests.invoice_request_thank_you")
    ...
    def portal_document_thank_you(self, **kw):
        ...
        return request.render("aicia_portal_requests.document_request_thank_you")
    ...
    def portal_project_request_thank_you(self, **kw):
        ...
        return request.render("aicia_portal_requests.project_request_thank_you")
    ...
    def portal_my_documents(self, page=1, sortby=None, filterby=None, search=None, search_in='all', groupby='none', **kw):
        ...
        return request.render("aicia_portal_requests.portal_my_documents", values)
    ...
    def portal_my_document_detail(self, document_id, success=None, **kw):
        ...
        if user.has_group('aicia_portal_requests.group_equip_boss') and document.work_group_id:
        ...
        return request.render("aicia_portal_requests.portal_my_document_detail", values)
    ...
    def portal_document_add_attachment(self, document_id, **post):
        ...
        is_owner = document.user_id == user
        is_boss_of_group = user.has_group('aicia_portal_requests.group_equip_boss') and document.work_group_id and document.work_group_id.equip_boss == user
        if not is_owner and not is_boss_of_group:
            return request.redirect('/my')
    ...
    def portal_my_projects(self, page=1, sortby=None, filterby=None, search=None, search_in='all', groupby='none', **kw):
        ...
        return request.render("aicia_portal_requests.portal_my_projects", values)
    ...
    def portal_my_project_detail(self, project_id, success=None, **kw):
        ...
        return request.render("aicia_portal_requests.portal_my_project_detail", values)
    ...
    def portal_project_invoices(self, project_id, search=None, search_in='all', groupby='none', filterby='all', **kw):
        ...
        return request.render("aicia_portal_requests.portal_project_invoices", values)
    ...
    def portal_project_invoice_detail(self, project_id, invoice_id, success=None, **kw):
        ...
        return request.render("aicia_portal_requests.portal_project_invoice_detail", values)
    ...
    def portal_project_invoice_payments(self, project_id, invoice_id, search=None, search_in='all', groupby='none', filterby='all', **kw):
        ...
        return request.render("aicia_portal_requests.portal_project_invoice_payments", values)
    ...
    def portal_project_invoice_payment_detail(self, project_id, invoice_id, payment_id, success=None, **kw):
        ...
        return request.render("aicia_portal_requests.portal_project_invoice_payment_detail", {
            'project': project.sudo(),
            'invoice': invoice,
            'payment': payment,
    ...
    def portal_my_project_requests(self, page=1, sortby=None, search=None, search_in='all', groupby='none', filterby='all', **kw):
        ...
        if not request.env.user.has_group('aicia_portal_requests.group_equip_boss'):
            return request.redirect('/my')
        ...
        return request.render("aicia_portal_requests.portal_my_project_requests", values)
    ...
    def portal_my_project_request_detail(self, request_id, success=None, **kw):
        ...
        return request.render("aicia_portal_requests.portal_my_project_request_detail", values)
