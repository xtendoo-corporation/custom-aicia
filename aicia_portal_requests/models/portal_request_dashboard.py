...
class PortalRequestDashboard(models.Model):
    ...
    def open_to_revise_expensive(self):
        if self.env.user.has_group('aicia_portal_requests.group_director_investigation_and_development') or self.env.user.has_group(
            'aicia_portal_requests.group_director_manager'):
            return {
        ...
        if self.env.user.has_group('aicia_portal_requests.group_personnel_purchase_responsible'):
            return {
                'name': _('Gastos para revisar'),
                'type': 'ir.actions.act_window',
                'res_model': 'portal.hr.expensive.request',
        ...
        if self.env.user.has_group('aicia_portal_requests.group_equip_boss'):
            return {
                'name': _('Gastos para revisar'),
                'type': 'ir.actions.act_window',
                'res_model': 'portal.hr.expensive.request',
        ...
        if self.env.user.has_group('aicia_portal_requests.group_project_boss'):
            return {
                'name': _('Gastos para revisar'),
                'type': 'ir.actions.act_window',
                'res_model': 'portal.hr.expensive.request',
    ...
    def open_to_revise_document(self):
        if self.env.user.has_group('aicia_portal_requests.group_director_investigation_and_development'):
            return {
        ...
        # if self.env.user.has_group('aicia_portal_requests.group_financial_director'):
        #     return {
        #         'name': _('Documentos para revisar'),
        #         'type': 'ir.actions.act_window',
        #         'res_model': 'document.approval',
        ...
        #         'context': {'group_by': 'type_id'},
        #     }
        if self.env.user.has_group('aicia_portal_requests.group_director_manager'):
            return {
                'name': _('Documentos para revisar'),
                'type': 'ir.actions.act_window',
                'res_model': 'document.approval',
        ...
        if self.env.user.has_group('aicia_portal_requests.group_project_boss') or self.env.user.has_group('aicia_portal_requests.group_equip_boss'):
            return {
                'name': _('Documentos para revisar'),
                'type': 'ir.actions.act_window',
                'res_model': 'document.approval',
    ...
    def open_to_revise_invoice(self):
        if self.env.user.has_group('aicia_portal_requests.group_director_investigation_and_development') or self.env.user.has_group('aicia_portal_requests.group_director_manager'):
            return {
        ...
        if self.env.user.has_group('aicia_portal_requests.group_intern_partner_responsible'):
            return {
                'name': _('Facturas para revisar'),
                'type': 'ir.actions.act_window',
                'res_model': 'portal.invoice.request',
