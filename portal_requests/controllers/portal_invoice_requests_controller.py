...
class PortalInvoiceController(Controller):
    ...
    def invoice_request_submit(self, **post):
        ...
        self.send_request_email(move_text,invoice_request.user_id.name,invoice_request.company_id.name,invoice_request.partner_id.name, invoice_request.notes, invoice_request.invoice_to_refund)
        return request.redirect('/contactus-thank-you')

    def send_request_email(self, move_text, user_name,company_name, partner_name, notes, invoice_to_refund):
        body_html = f"""
        ...
        mail_values = {
            ...
            'email_from': request.env.user.email or 'no-reply@example.com',  # Correo de envío
            'email_to': ','.join(email_list),  # Destinatarios
            'body_html': body_html,
        }
        ...
        #self.send_request_email(invoice_request)
        #return request.redirect('/contactus-thank-you')
